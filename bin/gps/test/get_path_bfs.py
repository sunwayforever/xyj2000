...
class Link:
    def __init__(self,roomno,linkroomno,direction,weight_type,is_boundary, linkroomname, src_room_zone, src_zone2, dst_room_zone, dst_zone2):
        self.roomno = roomno
        ...
        self.src_room_zone2 = src_zone2
        self.dst_room_zone2 = dst_zone2
        print(src_zone2)
...
conn = sqlite3.connect("/home/sunway/Dropbox/mud/xyj2000/db/rooms.db")
mud = MudRoom(conn, weights)

print (";".join(mud.get_path(262, 264)))
